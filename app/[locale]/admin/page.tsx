...
export default async function AdminDashboardPage({
  ...
  return (
    <div className="mx-6 flex flex-col pt-16 md:mx-8">
      ...
      <div className="mt-6 rounded-xl border border-neutral-200 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900">
        ...
        <ul className="space-y-1 text-sm text-neutral-600 dark:text-neutral-400">
          ...
          <li>
            Achievement unlock data is tracked client-side
            (localStorage) — server-side analytics not yet
            implemented
          </li>
          ...
          <li>
            <Link
              ...
              className="text-primary-600 underline hover:text-primary-400 dark:text-primary-400 dark:hover:text-primary-200"
            >
              Analytics dashboard
            </Link>
          </li>
