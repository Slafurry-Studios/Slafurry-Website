...
export default function Home() {
    return (
        <main className="w-screen h-screen flex flex-col items-center justify-start md:justify-center gap-4 md:gap-6 p-6 md:p-4 relative overflow-hidden bg-white selection:bg-none">
