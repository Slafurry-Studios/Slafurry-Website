...
export function PostCard({ post }: { post: MockPost }) {
  ...
  return (
    ...
    >
      <PlaceholderImage label={post.title} className="aspect-[21/9] w-full" />
      <div className="p-5">
        <h3 className="font-body text-lg font-semibold leading-snug">{post.title}</h3>
        ...
        <p className="mt-2 line-clamp-2 font-body text-sm text-neutral-600 dark:text-neutral-400">
          {post.excerpt}
        </p>
      </div>
    </Link>
